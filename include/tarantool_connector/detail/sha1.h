...
#ifndef TARANTOOL_CONNECTOR_SHA1_H
#define TARANTOOL_CONNECTOR_SHA1_H
...
static inline void SHA1Init(SHA1_CTX* context)
{
...
static inline void SHA1Final(unsigned char digest[20], SHA1_CTX* context)
{
  unsigned i;
...
#endif  // TARANTOOL_CONNECTOR_SHA1_H
